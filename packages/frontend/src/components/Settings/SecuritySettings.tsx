...
export const SecuritySettings: React.FC<SecuritySettingsProps> = ({ onSave, className }) => {
  ...
  const handlePasswordChange = (field: keyof typeof settings.password, value: string) => {
    setSettings((prev) => ({
      ...prev,
      password: {
        ...prev.password,
  ...
  const handleToggle2FA = async () => {
    const updatedSettings = {
      ...
      twoFactor: {
        ...
        backupCodes: !settings.twoFactor.enabled ? ['123456', '789012', '345678'] : [],
      },
    }
  ...
  const generateApiKey = () => {
    ...
    alert(`API Key generated: sk_test_${Math.random().toString(36).substring(7)}`)
  }
    ...
    <div className={cn('space-y-6', className)}>
        ...
        <CardContent>
          {!showPasswordForm ? (
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 mb-2">Last changed: January 1, 2024</p>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-3">
                  Save these codes in a secure place. You can use them to access your account if you
                  lose your device.
                </p>
      ...
      <Card className="bg-white/50 backdrop-blur-sm border border-white/30">
        <CardHeader>
          ...
          <CardDescription>Get notified about account security events</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="font-medium text-gray-900">Login Notifications</div>
              <div className="text-sm text-gray-600">Enable all login notifications</div>
            </div>
            <Toggle
            ...
            <>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-gray-600">When you sign in from a new device</div>
                </div>
                <Toggle
                  ...
                  onCheckedChange={async (checked) => {
                    ...
                    try {
                      ...
                      console.error('Failed to update new device notifications:', error)
                      setSettings(settings)
                    }
                  }}
                  size="sm"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-gray-600">When we detect unusual login patterns</div>
                </div>
                <Toggle
                  ...
                  onCheckedChange={async (checked) => {
                    ...
                    try {
                      ...
                      console.error('Failed to update suspicious activity notifications:', error)
                      setSettings(settings)
                    }
                  }}
                  size="sm"
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge variant={apiKey.active ? 'success' : 'secondary'} size="sm">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {['read:tasks', 'write:tasks', 'read:projects', 'write:projects'].map(
                      (permission) => (
