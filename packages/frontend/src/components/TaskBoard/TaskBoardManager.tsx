...
export const TaskBoardManager: React.FC<TaskBoardManagerProps> = ({
  ...
  const { isUpdating, updateError, updateTaskStatus, clearUpdateError } = useTaskUpdates({
    projectId,
        ...
        <div className="task-board-manager__controls">
          {showFilters && (
            <div className="filter-controls">
              ...
              <button className="clear-filters-button" onClick={() => handleFilterChange({})}>
                Clear Filters
              </button>
            </div>
          )}
      ...
      {showDevTools && (
        <div className="task-board-manager__dev-tools">
          ...
          <div className="dev-tools-grid">
            ...
            <button onClick={handleClear} disabled={isLoading} className="dev-tool-button clear">
              Clear
            </button>
          ...
          <div className="dev-tools-info">
            ...
            <p>
              <strong>Sort:</strong> {sortOptions.field} ({sortOptions.direction})
            </p>
            <p>
            ...
            <p>
              ...
              {repositoryPath ? 'Repository' : filePath ? 'File' : projectId ? 'Project' : 'Sample'}
            </p>
            <p>
              <strong>Real-time:</strong> {isRealtimeActive ? 'Active' : 'Inactive'}
            </p>
            <p>
            ...
            <p>
              <strong>Task Updates:</strong> {isUpdating ? 'In Progress' : 'Ready'}
            </p>
            {lastUpdateTime && (
              <p>
            ...
            {updateError && (
              <div className="dev-tools-error">
                ...
                <button onClick={clearUpdateError} className="dev-tool-button clear-error">
                  Clear Error
                </button>
              </div>
            )}
