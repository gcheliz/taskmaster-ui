...
exports.commandCache = exports.globalCache = exports.CommandResultCache = exports.AdvancedCacheManager = void 0;
const events_1 = require("events");
/**
 * Advanced LRU Cache with Performance Optimization
 */
class AdvancedCacheManager extends events_1.EventEmitter {
    constructor(config = {}) {
        super();
        this.cache = new Map();
        this.accessOrder = [];
    ...
    updateStatistics(operation, startTime) {
 ...
 */
class CommandResultCache extends AdvancedCacheManager {
    constructor() {
        super({
            maxSize: 500,
     ...
     */
    generateCommandKey(repositoryPath, operation, args) {
     ...
     */
    async cacheCommandResult(repositoryPath, operation, args, result) {
     ...
     */
    async getCachedCommandResult(repositoryPath, operation, args) {
        const key = this.generateCommandKey(repositoryPath, operation, args);
...
exports.CommandResultCache = CommandResultCache;
// Export instances
exports.globalCache = new AdvancedCacheManager();
exports.commandCache = new CommandResultCache();
