...
describe('FormField', () => {
  ...
  it('displays success message when provided', () => {
    render(<FormField label="Test Label" success="This is success" />)
  ...
  it('applies correct size classes', () => {
    render(<FormField label="Test Label" inputSize="lg" />)

    expect(screen.getByRole('textbox')).toHaveClass('h-12', 'px-4', 'text-lg')
  })

  it('renders with description', () => {
    render(<FormField label="Test Label" description="This is a description" />)
