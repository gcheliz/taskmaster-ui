...
describe('ProjectController', () => {
  ...
  describe('createProject', () => {
    it('should create project successfully with valid data', async () => {
      ...
      (taskMasterService.initProject as jest.Mock).mockResolvedValue(mockTaskMasterResult);
      ...
      expect(taskMasterService.initProject).toHaveBeenCalledWith('/Users/test/project');
    ...
    it('should return 500 when TaskMaster CLI throws an error', async () => {
      ...
      (repositoryService.getRepositoryById as jest.Mock).mockResolvedValue(mockRepository);
      (taskMasterService.initProject as jest.Mock).mockRejectedValue(initError);
