...
describe('RepositoryDetailsView', () => {
  ...
  it('calls onRepositoryClick when repository is clicked', async () => {
    ...
    render(
      <RepositoryDetailsView repositoryId="test-repo-1" onRepositoryClick={mockRepositoryClick} />
    )
  ...
  it('calls onBranchClick when branch is clicked', async () => {
    ...
    render(<RepositoryDetailsView repositoryId="test-repo-1" onBranchClick={mockBranchClick} />)
