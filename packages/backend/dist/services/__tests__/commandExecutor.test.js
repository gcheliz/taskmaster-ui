...
describe('CommandExecutor', () => {
    ...
    describe('Error Handling', () => {
        it('should handle command that does not exist', async () => {
            await expect(executor.executeCommand('nonexistentcommand', ['arg1'])).rejects.toThrow(commandExecutor_1.CommandExecutionError);
        });
        it('should capture stderr from failing command', async () => {
            try {
                ...
                expect(error).toBeInstanceOf(commandExecutor_1.CommandExecutionError);
    ...
    describe('Event Handling', () => {
        it('should emit progress events during command execution', async () => {
            const events = [];
            executor.on('progress', (processId, progress) => {
    ...
    describe('Sequential Execution', () => {
        ...
        it('should stop sequence on first failure', async () => {
            ...
            await expect(executor.executeSequence(commands)).rejects.toThrow(commandExecutor_1.CommandExecutionError);
        });
    });
