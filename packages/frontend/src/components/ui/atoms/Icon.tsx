...
// SVG Icons using Tailwind CSS styling
...
export const CompleteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Navigation Icons
export const HomeFilledIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ShareSocialIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Legacy aliases
export const TagIcon = TaggedIcon
export const CalendarIcon = CalendarDaysIcon
export const ShareIcon = ShareSocialIcon
...
export interface IconProps
   ...
   * @default 'current'
   */
  color?: 'current' | 'primary' | 'secondary' | 'success' | 'warning' | 'error' | 'muted' | 'white'
}

const Icon = React.forwardRef<HTMLSpanElement, IconProps>(
  ({ className, size, color, icon: IconComponent, 'aria-label': ariaLabel, ...props }, ref) => {
    return (
      <span
        ref={ref}
