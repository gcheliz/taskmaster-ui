    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className={`flex items-center gap-2 px-3 py-1 rounded-full ${healthBg}`}>
            <Activity className={`w-4 h-4 ${healthColor}`} />
            <span className={`font-medium ${healthColor}`}>{projectHealth}%</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-gray-900">{activeRepos}</div>
            <div className="text-sm text-gray-600 mt-1">Active Repositories</div>
          </div>
          <div className="text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-500">This Sprint</span>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
          ...
          <div className="text-2xl font-bold text-gray-900">{blockedTasks}</div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-500">Avg/Week</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600">Due in 5 days • 85% complete</div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600">Due in 12 days • 60% complete</div>
                <div className="mt-2 w-full bg-gray-200 rounded-full h-1.5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600">Due in 20 days • 30% complete</div>
                <div className="mt-2 w-full bg-gray-200 rounded-full h-1.5">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            ...
            <button 
              onClick={() => navigate('/repositories')}
              className="w-full mt-2 text-sm text-blue-600 hover:text-blue-700 font-medium py-2"
            >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <span className="text-gray-700 font-medium">View Tasks</span>
        </button>
