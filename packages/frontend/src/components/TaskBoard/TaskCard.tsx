...
const TaskCardComponent = ({
  ...
  // Check if this is an optimistic task (has negative ID or _optimistic flag)
  ...
  return (
    <div
      ...
      className={`
        ...
        ${isOptimistic ? 'opacity-70 bg-gradient-to-r from-blue-50 to-white animate-pulse' : ''}
        ${className}
      `.trim()}
      style={
        {
    ...
    >
      ...
      {/* Saving indicator for optimistic tasks */}
      {isOptimistic && (
