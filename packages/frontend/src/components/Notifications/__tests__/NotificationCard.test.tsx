...
describe('NotificationCard', () => {
  ...
  it('renders notification with title and message', () => {
    render(<NotificationCard notification={mockNotification} onDismiss={mockOnDismiss} />)
  ...
  it('renders correct icon for error type', () => {
    ...
    render(<NotificationCard notification={errorNotification} onDismiss={mockOnDismiss} />)
  ...
  it('renders correct icon for warning type', () => {
    ...
    render(<NotificationCard notification={warningNotification} onDismiss={mockOnDismiss} />)
  ...
  it('renders correct icon for info type', () => {
    ...
    render(<NotificationCard notification={infoNotification} onDismiss={mockOnDismiss} />)
  ...
  it('hides dismiss button when dismissible is false', () => {
    ...
    render(<NotificationCard notification={nonDismissibleNotification} onDismiss={mockOnDismiss} />)
  ...
  it('renders action button when action is provided', () => {
    ...
    render(<NotificationCard notification={notificationWithAction} onDismiss={mockOnDismiss} />)
  ...
  it('does not render message when not provided', () => {
    ...
    render(<NotificationCard notification={notificationWithoutMessage} onDismiss={mockOnDismiss} />)
