...
const taskMasterTerminalController_1 = require("../controllers/taskMasterTerminalController");
 ...
 */
router.post('/sessions', taskMasterTerminalController_1.taskMasterTerminalController.createSession.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 * /api/taskmaster-terminal/sessions:
 *   get:
 ...
 *                       example: 3
 */
router.get('/sessions', taskMasterTerminalController_1.taskMasterTerminalController.getActiveSessions.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 ...
 */
router.get('/sessions/:sessionId', taskMasterTerminalController_1.taskMasterTerminalController.getSession.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 ...
 *         description: Session not found
 */
router.post('/sessions/:sessionId/commands', taskMasterTerminalController_1.taskMasterTerminalController.executeCommand.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 ...
 *                       example: "task-master li"
 */
router.get('/sessions/:sessionId/suggestions', taskMasterTerminalController_1.taskMasterTerminalController.getCommandSuggestions.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 ...
 *                       example: 0
 */
router.get('/sessions/:sessionId/history', taskMasterTerminalController_1.taskMasterTerminalController.getCommandHistory.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 ...
 */
router.post('/sessions/:sessionId/input', taskMasterTerminalController_1.taskMasterTerminalController.sendInput.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 ...
 *         description: Session not found or no running process
 */
router.post('/sessions/:sessionId/kill', taskMasterTerminalController_1.taskMasterTerminalController.killProcess.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 ...
 *         description: Session not found
 */
router.post('/sessions/:sessionId/resize', taskMasterTerminalController_1.taskMasterTerminalController.resizeTerminal.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 ...
 *                       example: true
 */
router.get('/sessions/:sessionId/environment', taskMasterTerminalController_1.taskMasterTerminalController.getEnvironment.bind(taskMasterTerminalController_1.taskMasterTerminalController));
/**
 * @swagger
 * /api/taskmaster-terminal/sessions/{sessionId}:
 *   delete:
 ...
 *         description: Session not found
 */
router.delete('/sessions/:sessionId', taskMasterTerminalController_1.taskMasterTerminalController.closeSession.bind(taskMasterTerminalController_1.taskMasterTerminalController));
exports.default = router;
//# sourceMappingURL=taskMasterTerminalRoutes.js.map