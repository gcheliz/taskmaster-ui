  ...
  return (
    <div className={`project-dashboard ${className}`} data-testid="project-dashboard">
      ...
      {notification && (
        ...
        >
          <span className="notification-message" data-testid="notification-message">
      ...
      <div className="project-dashboard__header">
        <div className="header-content">
          ...
          <p className="dashboard-subtitle">Manage your TaskMaster projects and repositories</p>
        </div>
        ...
        <div className="project-dashboard__quick-actions">
          <div className="quick-actions-content">
            ...
            <p className="quick-actions-description">
              Create your first TaskMaster project to start organizing and tracking your development
              tasks.
            </p>
