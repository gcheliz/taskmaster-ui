...
describe('RepositoryManagementView', () => {
  it('renders the main heading', () => {
    ...
    expect(
      screen.getByRole('heading', { level: 1, name: 'Repository Management' })
    ).toBeInTheDocument()
  })
  ...
  it('renders the view description', () => {
    render(<RepositoryManagementView />)
    expect(
      screen.getByText('Connect and manage your Git repositories for task tracking and automation.')
    ).toBeInTheDocument()
  })
  ...
  it('renders coming soon message', () => {
    ...
    expect(
      screen.getByText('Repository management features will be implemented here.')
    ).toBeInTheDocument()
  })
