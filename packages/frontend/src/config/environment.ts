...
class EnvironmentManager {
  ...
  private loadConfiguration(): EnvironmentConfig {
    ...
    return {
      ...
      allowedFileTypes: this.getStringArray('VITE_TASKMASTER_ALLOWED_FILE_TYPES', [
        'txt',
        'md',
        'json',
      ]),
  ...
  private getBoolean(key: string, defaultValue: boolean): boolean {
    ...
    return (
      stringValue === 'true' || stringValue === '1' || stringValue === 'yes' || stringValue === 'on'
    )
  }
...
export const isFeatureEnabled = (feature: Parameters<typeof env.isFeatureEnabled>[0]) =>
