...
describe('Card', () => {
  ...
  it('renders CardHeader with proper styling', () => {
    ...
    expect(screen.getByTestId('header')).toHaveClass('flex', 'flex-col', 'space-y-1.5', 'items-start', 'text-left');
  });
  ...
  it('renders CardTitle with proper styling', () => {
    ...
    expect(screen.getByTestId('title')).toHaveClass('text-headline-medium', 'font-semibold', 'leading-none', 'tracking-tight');
  });
  ...
  it('renders CardFooter with proper styling', () => {
    ...
    expect(screen.getByTestId('footer')).toHaveClass('flex', 'items-center', 'pt-6', 'justify-start');
  });
});