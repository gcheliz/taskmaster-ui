        ...
        try {
            const settings = await prisma.userSettings.create({
                data: {
                    ...
                    notificationSettings: data.notificationSettings === null ? client_1.Prisma.JsonNull : data.notificationSettings,
                    integrationSettings: data.integrationSettings === null ? client_1.Prisma.JsonNull : data.integrationSettings,
                    twoFactorEnabled: data.twoFactorEnabled,
                    loginNotifications: data.loginNotifications,
                    securitySettings: data.securitySettings === null ? client_1.Prisma.JsonNull : data.securitySettings,
