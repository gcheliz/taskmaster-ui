  ...
  render: (args) => {
    ...
    return (
      <div className="flex items-center space-x-3">
        <Toggle id="toggle-with-label" checked={checked} onCheckedChange={setChecked} {...args} />
    ...
    return (
      <div className="flex items-center space-x-8">
        <div className="flex items-center space-x-2">
          <Toggle size="sm" checked={smallChecked} onCheckedChange={setSmallChecked} />
          <Label size="sm">Small</Label>
        </div>
        <div className="flex items-center space-x-2">
          <Toggle size="md" checked={mediumChecked} onCheckedChange={setMediumChecked} />
          <Label size="md">Medium</Label>
        </div>
        <div className="flex items-center space-x-2">
          <Toggle size="lg" checked={largeChecked} onCheckedChange={setLargeChecked} />
...
export const Variants: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center space-x-3">
          <Toggle variant="default" checked={defaultChecked} onCheckedChange={setDefaultChecked} />
          <Label>Default</Label>
        </div>
        <div className="flex items-center space-x-3">
          <Toggle variant="error" checked={errorChecked} onCheckedChange={setErrorChecked} />
          <Label error>Error State</Label>
        </div>
        <div className="flex items-center space-x-3">
          <Toggle variant="success" checked={successChecked} onCheckedChange={setSuccessChecked} />
  ...
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-sm text-secondary-600">Current state: {isEnabled ? 'ON' : 'OFF'}</p>
      </div>
    )
  },
}
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-secondary-500">Receive email updates about your tasks</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-secondary-500">Get browser notifications for updates</p>
              </div>
              <Toggle checked={pushNotifications} onCheckedChange={setPushNotifications} />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Toggle checked={smsNotifications} onCheckedChange={setSmsNotifications} disabled />
            </div>
          </div>
        </fieldset>

        <fieldset className="space-y-6">
          <legend className="text-base font-medium text-secondary-900">Preferences</legend>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Toggle checked={darkMode} onCheckedChange={setDarkMode} variant="default" />
            </div>

            <div className="flex items-center justify-between">
              <div>
                <Label className="cursor-pointer">Auto-save</Label>
                <p className="text-sm text-secondary-500">Automatically save your work</p>
              </div>
              <Toggle checked={autoSave} onCheckedChange={setAutoSave} variant="success" />
            </div>
          </div>
        </fieldset>
      </form>
