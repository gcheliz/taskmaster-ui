...
describe('BranchList', () => {
  ...
  it('applies custom className correctly', () => {
    const { container } = render(<BranchList branches={mockBranches} className="custom-class" />)
  ...
  it('sorts branches correctly (current first, then local, then remote)', () => {
    ...
    const branchNames = screen.getAllByText((_, element) => element?.className === 'branch-name')
