...
const validateBranchName = (name: string): string | null => {
  ...
  if (
    RESERVED_BRANCH_NAMES.some(reserved =>
  ...
  useEffect(() => {
    if (repositoryBranches && repositoryBranches.length > 0) {
      ...
      setAvailableBranches(
        branchNames.length > 0 ? branchNames : ['main', 'develop', 'master']
      );
      ...
      <form onSubmit={handleSubmit}>
        <ModalHeader>
          ...
          <p className="text-sm text-gray-600 mt-1">
            {repositoryId &&
              `Create a new branch in repository ${repositoryId}`}
          </p>
        </ModalHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                aria-describedby={
                  validationError ? 'branch-name-error' : undefined
                }
              />
              {validationError && (
              ...
              <p className="text-xs text-gray-500">
                Use a descriptive name like "feature/user-authentication" or
                "bugfix/login-issue"
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              {isLoadingDetails ? (
                ...
                <select
                  ...
                  onChange={e =>
                    handleInputChange('fromBranch')(e.target.value)
                  }
                  disabled={isCreating}
                ...
                >
                  {availableBranches.map(branch => (
                    <option key={branch} value={branch}>
                      {branch}
                      {repositoryDetails?.currentBranch === branch &&
                        ' (current)'}
                    </option>
                  ))}
                </select>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-blue-800">
                    About Branch Creation
                  </h3>
                  <div className="mt-2 text-sm text-blue-700">
                    <ul className="list-disc list-inside space-y-1">
                      <li>The new branch will be created locally</li>
                      <li>
                        You can push it to remote later using the sync feature
                      </li>
                      <li>
                        Use forward slashes (/) to organize branches into
                        folders
                      </li>
                    </ul>
                  </div>
