              ...
              <div className="text-center">
                ...
                {process.env.NODE_ENV === 'development' && (
                  <div className="mb-6 p-3 bg-red-50 border border-red-200 rounded-md text-left">
                    <p className="text-xs text-red-800 font-mono">Error ID: {errorId}</p>
                    <p className="text-xs text-red-800 font-mono mt-1">{error?.message}</p>
                  </div>
                )}
      ...
      return (
        <Card className="p-6 border-red-200 bg-red-50">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Section Error</h3>
            <p className="text-sm text-gray-600 mb-4">
              {context ? `Error in ${context}` : 'This section encountered an error.'}
            </p>

            <div className="flex gap-2 justify-center">
              <Button onClick={this.handleRetry} size="sm" className="flex items-center gap-1">
      ...
      <div className="p-4 border border-red-200 rounded-md bg-red-50">
        <div className="flex items-start">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-medium text-red-800 mb-1">Component Error</h4>
