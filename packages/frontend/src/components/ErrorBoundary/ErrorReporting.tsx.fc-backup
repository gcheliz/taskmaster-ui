      ...
      <div className="p-6">
        ...
        {reportSent ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600">Thank you for helping us improve TaskMaster UI!</p>
          </div>
        ) : (
              ...
              <Card className="p-3 bg-gray-50 border">
                <div className="space-y-2 text-sm">
                  <div>
                    ...
                    <code className="text-xs bg-gray-200 px-1 rounded">{error.errorId}</code>
                  </div>
                  <div>
                    <span className="font-medium">Type:</span> {error.error.name}
                  </div>
                  <div>
                    <span className="font-medium">Message:</span> {error.error.message}
                  </div>
                  <div>
                    <span className="font-medium">Context:</span> {error.context || 'Unknown'}
                  </div>
                  <div>
      ...
      <div className="fixed bottom-4 right-4 z-50">
        <Card className="p-3 bg-red-50 border-red-200 shadow-lg">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={clearAllErrors} size="sm" variant="ghost" className="text-xs">
              Dismiss All
            </Button>
          </div>
        </Card>
