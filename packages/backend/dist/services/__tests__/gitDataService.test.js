...
describe('GitDataService', () => {
    ...
    let mockGit;
    beforeEach(() => {
        gitService = new gitDataService_1.GitDataService();
    ...
    describe('configuration', () => {
        it('should create service with custom timeout', () => {
            const customService = new gitDataService_1.GitDataService({ timeout: 60000 });
            expect(customService).toBeInstanceOf(gitDataService_1.GitDataService);
        });
        it('should use default timeout when none provided', () => {
            const defaultService = new gitDataService_1.GitDataService();
            expect(defaultService).toBeInstanceOf(gitDataService_1.GitDataService);
        });
    });
});
//# sourceMappingURL=gitDataService.test.js.map