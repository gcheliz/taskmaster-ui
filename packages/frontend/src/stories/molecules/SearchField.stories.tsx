    ...
    <div className="space-y-6 w-full max-w-2xl">
      <div>
        ...
        <p className="text-sm text-secondary-600 mb-4">
          Search fields include proper ARIA labels and live regions for
          accessibility.
        </p>
        ...
        <div id="search-help" className="text-xs text-secondary-500 mt-1">
          Use this field to search across all your projects and tasks. Press
          Enter or click the search button to start searching.
        </div>
      </div>
      ...
      <div>
        ...
        <p className="text-xs text-secondary-600 mt-2">
          Enhanced visual contrast for better visibility and accessibility
          compliance.
        </p>
      </div>
    </div>
