...
exports.taskMasterOutputParser = exports.TaskMasterOutputParser = void 0;
/**
...
class NextTaskParsingStrategy {
    ...
    parseDependencies(depStr) {
        if (depStr.toLowerCase().includes('none'))
            return [];
...
class TaskMasterOutputParser {
     ...
     */
    extractOperationResult(output, operation) {
...
exports.TaskMasterOutputParser = TaskMasterOutputParser;
// Export singleton instance
exports.taskMasterOutputParser = new TaskMasterOutputParser();
//# sourceMappingURL=taskMasterOutputParser.js.map