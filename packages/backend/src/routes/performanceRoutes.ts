...
router.get(
  '/analysis',
  performanceController.getQueryAnalysis.bind(performanceController)
);
...
router.delete(
  '/logs',
  performanceController.clearLogs.bind(performanceController)
);
...
router.get(
  '/logs/export',
  performanceController.exportLogs.bind(performanceController)
);
...
router.get(
  '/connection',
  performanceController.getConnectionInfo.bind(performanceController)
);
...
router.post(
  '/test',
  performanceController.runPerformanceTest.bind(performanceController)
);
...
router.get(
  '/slow-queries',
  performanceController.analyzeSlowQueries.bind(performanceController)
);
...
router.put(
  '/toggle',
  performanceController.toggleAnalysis.bind(performanceController)
);
